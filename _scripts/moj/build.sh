...
# https://github.com/ministryofjustice/hmpps-tech-docs/blob/main/bin/build.sh
# https://raw.githubusercontent.com/ministryofjustice/hmpps-tech-docs/main/bin/build.sh
