...
# https://github.com/ministryofjustice/hmpps-tech-docs/blob/main/bin/publish.sh
# https://raw.githubusercontent.com/ministryofjustice/hmpps-tech-docs/main/bin/publish.sh
